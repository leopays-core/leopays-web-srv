  ...
  logger: {
    ...
    gelf: {
      ...
      hostname: {
        ...
        format: String,
        default: "srv_" + require('os').hostname(), // hostname - string(defaults to OS.hostname()) - the hostname used to identify the origin of the log messages.
      },
      facility: {
        doc: "logger gelf facility",
        format: String,
        default: "srv", // facility - string(optional)
      },
      customFields: {
